import { isObject, isString, isNumber, isCssVar, memoizedGet, objectKeys, mergeWith, pick, flatten, fromEntries, analyzeBreakpoints, runIfFn, isArray } from '@chakra-ui/utils';
...
var tokenToCSSVar = function tokenToCSSVar(scale, value) {
  return function (theme) {
    ...
    var _value = withoutImportant(valueStr);

    var key = scale ? scale + "." + _value : _value;
    ...
    var _loop = function _loop(i) {
      ...
      if (last && isMultipart) {
        ...
        (_config$parts = config.parts) == null ? void 0 : _config$parts.forEach(function (part) {
          ...
          mergeWith(result, (_mergeWith = {}, _mergeWith[part] = isSingle ? styles[part] : (_ref = {}, _ref[key.minWQuery] = styles[part], _ref), _mergeWith));
        });
        return "continue";
      }
      ...
      if (isMultipart) {
        ...
        (_config$parts2 = config.parts) == null ? void 0 : _config$parts2.forEach(function (part) {
          var _ref2, _mergeWith2;

          mergeWith(result, (_mergeWith2 = {}, _mergeWith2[part] = isSingle ? styles[part] : (_ref2 = {}, _ref2[key.minMaxQuery] = styles[part], _ref2), _mergeWith2));
        });
        return "continue";
      }
